    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/user-page", "/profile", "/user-page-utilities","/apply-utility","/user-page-utility").hasAuthority("USER")
                        .requestMatchers("/provider-page", "/provider/requests","/provider-utilities","/edit-utilityOffer","/utilityOffers/CreateUtilityOffers", "/provider/clients-feedback", "/provider/requests-utility").hasAuthority("PROVIDER")
