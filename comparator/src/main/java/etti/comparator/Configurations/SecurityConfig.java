        ...
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/registration","/ServicesComparator", "/registrationasprovider", "/css/**", "/index", "/CreateProduct", "/EditProduct",
                                "/servicii","/forgot-password", "/products", "services", "/service-list","/serviceOffers/CreateServiceOffers", "/serviceOffers/EditServiceOffers", "/products/create", "/products/delete", "/products/edit", "/compare-services", "/utilitati", "/images/**").permitAll()
